...
test('decode stream', function (t) {
  ...
  t.test('buffering', function (t) {
    const stream = bp.createDecodeStream()
    const data = Buffer.from('f9beb4d970696e67000000000000000008000000137ad6630123456789abcdef', 'hex')
    stream.once('data', function (message) {
      t.true(message, 'got data')
      t.same(message.magic, 3652501241, 'correct magic')
  ...
  t.test('decode segwit tx', function (t) {
    const txBytes = Buffer.from('', 'hex')
    const tx = bp.types.transaction.decode(txBytes)
    t.same(tx.version, 2)
    t.same(tx.marker, 0)
    t.same(tx.flag, 1)
